...
VALUES
    ('HK', 'market_cap_range', '市值范围', 'filter', 'MarketCapFilter', '{"min_cap": null, "max_cap": null}', 0, 10, '按市值上下限筛选'),
    ('HK', 'avg_daily_volume_range', '每日平均交易量范围', 'filter', 'AvgDailyVolumeFilter', '{"min_volume": null, "max_volume": null}', 0, 20, '按 K 线计算每日平均交易量'),
    ('HK', 'price_range', '价格范围', 'filter', 'PriceFilter', '{"min_price": null, "max_price": null}', 0, 30, '按最新收盘价筛选'),
    ('HK', 'pe_range', 'PE 范围', 'filter', 'PEFilter', '{"min_pe": null, "max_pe": null, "allow_negative": false}', 0, 40, '按 PE 上下限筛选'),
    ('HK', 'profitability', '公司盈利', 'filter', 'ProfitabilityFilter', '{"require_profitable": true}', 0, 50, '要求 PE 为正'),
    ('HK', 'zuoyi_signal', '左一战法', 'strategy', 'ZuoYiStrategizer', '{"signal_window": 3, "include_bullish": true, "include_bearish": true}', 1, 110, '当前周期左一战法看涨/看跌信号'),
    ...
    ('US', 'market_cap_range', '市值范围', 'filter', 'MarketCapFilter', '{"min_cap": null, "max_cap": null}', 0, 10, '按市值上下限筛选'),
    ('US', 'avg_daily_volume_range', '每日平均交易量范围', 'filter', 'AvgDailyVolumeFilter', '{"min_volume": null, "max_volume": null}', 0, 20, '按 K 线计算每日平均交易量'),
    ('US', 'price_range', '价格范围', 'filter', 'PriceFilter', '{"min_price": null, "max_price": null}', 0, 30, '按最新收盘价筛选'),
    ('US', 'pe_range', 'PE 范围', 'filter', 'PEFilter', '{"min_pe": null, "max_pe": null, "allow_negative": false}', 0, 40, '按 PE 上下限筛选'),
    ('US', 'profitability', '公司盈利', 'filter', 'ProfitabilityFilter', '{"require_profitable": true}', 0, 50, '要求 PE 为正'),
    ('US', 'zuoyi_signal', '左一战法', 'strategy', 'ZuoYiStrategizer', '{"signal_window": 3, "include_bullish": true, "include_bearish": true}', 1, 110, '当前周期左一战法看涨/看跌信号'),
    ...
    ('A', 'market_cap_range', '市值范围', 'filter', 'MarketCapFilter', '{"min_cap": null, "max_cap": null}', 0, 10, '按市值上下限筛选'),
    ('A', 'avg_daily_volume_range', '每日平均交易量范围', 'filter', 'AvgDailyVolumeFilter', '{"min_volume": null, "max_volume": null}', 0, 20, '按 K 线计算每日平均交易量'),
    ('A', 'price_range', '价格范围', 'filter', 'PriceFilter', '{"min_price": null, "max_price": null}', 0, 30, '按最新收盘价筛选'),
    ('A', 'pe_range', 'PE 范围', 'filter', 'PEFilter', '{"min_pe": null, "max_pe": null, "allow_negative": false}', 0, 40, '按 PE 上下限筛选'),
    ('A', 'profitability', '公司盈利', 'filter', 'ProfitabilityFilter', '{"require_profitable": true}', 0, 50, '要求 PE 为正'),
    ('A', 'zuoyi_signal', '左一战法', 'strategy', 'ZuoYiStrategizer', '{"signal_window": 3, "include_bullish": true, "include_bearish": true}', 1, 110, '当前周期左一战法看涨/看跌信号'),
